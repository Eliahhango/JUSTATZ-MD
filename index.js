...
var session = conf.session.replace(/JUSTATZ-MD;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['JUSTATZ-MD', "safari", "1.0.0"],
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '255774044662';
            const dj2 = '255774044662';
            const dj3 = "255774044662";
            const luffy = '255774044662';
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by JUSTATZ-MD .`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ JUSTATZ-MD connecting in your account...");
            }
            else if (connection === 'open') {
                console.log("✅ JUSTATZ-MD connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("JUSTAZ-MD by JUSTATZ TECH installing cmds😇\n\n");
                ...
                console.log("JUSTAZ-MD successfully connected✅");

                await activateCrons();
                
                if((conf.DP).toLowerCase() === 'yes') {     
                let cmsg = `JUSTATZ-MD IS RUNNING NOW...
...
> THANK YOU FOR CHOOSING JUSTATZ-MD.\n`;
                await zk.sendMessage("255774044662"
                 "-@s.whatsapp.net", { text: cmsg });
                }
            }
                ...
                else if (raisonDeconnexion === baileys_1."
                ℅) {
